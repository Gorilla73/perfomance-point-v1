...
function TablePossibilitiesIndTotalOpp( {data, headToHead, team_name} ) {
    return data && (
        <div>
            <table className="table-bet">
                <thead>
                <tr>
                    <th>{headToHead ? team_name : ''}</th>
                    <th>{headToHead ? 'ИТБ' : 'ИТБ 2'}</th>
                    <th>{headToHead ? 'ИТМ' : 'ИТМ 2'}</th>
                </tr>
                </thead>
                <tbody>
...
export default TablePossibilitiesIndTotalOpp;